...
export function TermsContent() {
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-16 text-foreground/80">
      <h1 className="mb-8 text-2xl font-bold text-foreground">{t("terms.title")}</h1>
      <p className="mb-6 text-sm text-muted-foreground">{t("terms.lastUpdated")}</p>

      <section className="space-y-6 text-sm leading-relaxed">
        <div>
          <h2 className="mb-2 text-lg font-semibold text-foreground">{t("terms.introTitle")}</h2>
          <p>{t("terms.introBody")}</p>
        </div>

        <div>
          <h2 className="mb-2 text-lg font-semibold text-foreground">{t("terms.serviceTitle")}</h2>
          <p>{t("terms.serviceBody")}</p>
        </div>

        <div>
          <h2 className="mb-2 text-lg font-semibold text-foreground">{t("terms.accountTitle")}</h2>
        ...
        <div>
          <h2 className="mb-2 text-lg font-semibold text-foreground">{t("terms.changesTitle")}</h2>
          <p>{t("terms.changesBody")}</p>
        </div>

        <div>
          <h2 className="mb-2 text-lg font-semibold text-foreground">{t("terms.contactTitle")}</h2>
